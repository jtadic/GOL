function [resulting_pattern]=f_game_of_life(init_pattern, rules, no_iterations)
...
% in the simulation
% 1 - original rules reflecting under and overpopulations rules
